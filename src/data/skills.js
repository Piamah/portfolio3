...
export const skillsGraph = [
    ...
    {name: "indesign", icon: "/assets/icons/indesign.png"},
    {name: "illustrator", icon: "/assets/icons/illustrator.png"},
    {name: "procreate", icon: "/assets/icons/html.png"},
    {name: "affinity", icon: "/assets/icons/affinity.png"},
];